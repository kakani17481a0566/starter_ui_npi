        ...
        <>
          <AccordionButton
            className={clsx(
              ...
              open
                ? "dark:text-dark-50 font-semibold text-primary-950 dark:text-dark-100 "
                : "dark:text-dark-200 dark:hover:text-dark-50 dark:focus:text-dark-50 text-gray-600 hover:text-primary-950 dark:text-dark-100  focus:text-primary-950 dark:text-dark-100 ",
            )}
          >
