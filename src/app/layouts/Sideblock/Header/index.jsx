...
export function Header() {
  ...
  return (
    <header
      className={clsx(
        // reomved px-(--margin-x)
        "app-header transition-content sticky top-0 z-20 flex h-[65px] items-center gap-1 border-b border-gray-200 bg-white/80  backdrop-blur-sm backdrop-saturate-150 dark:border-dark-600 max-sm:justify-between",
