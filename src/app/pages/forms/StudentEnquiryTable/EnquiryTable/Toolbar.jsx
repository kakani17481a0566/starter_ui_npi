// src/app/pages/forms/StudentEnquiryTable/EnquiryTable/Toolbar.jsx
            ...
            >
              <MenuItem>
                {({ focus }) => (
                  <button
                    className={clsx(
                      "flex h-8 w-full items-center px-3 text-xs tracking-wide outline-hidden transition-colors",
                      focus &&
              ...
              <hr className="mx-3 my-1 h-px border-gray-150 dark:border-dark-500" />
              <MenuItem>
                {({ focus }) => (
                  <button
                    className={clsx(
...
function SearchInput({ table }) {
  return (
    <Input
      ...
      placeholder="Search Enquiry ID, Student..."
    />
  );
}
