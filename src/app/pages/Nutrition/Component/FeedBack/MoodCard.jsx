...
export default function MoodCard({
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-green-100 to-green-200 font-sans">
      <form
        onSubmit={onSave}
        className="w-[450px] bg-white rounded-xl shadow-lg overflow-hidden"
      >
        {/* Dynamic Header */}
        <div
