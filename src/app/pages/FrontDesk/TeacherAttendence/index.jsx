// src/app/pages/FrontDesk/TeacherAttendence/index.jsx
import {
  flexRender,
  getCoreRowModel,
  getExpandedRowModel,
...
export default function TeacherAttendanceStatusDisplayTable({ data }) {
  const [autoResetPageIndex, skipAutoResetPageIndex] = useSkipper();

  // ✅ Initialize orders from props
  const [orders, setOrders] = useState([...data]);

  // ✅ Sync whenever parent passes new filtered data
  useEffect(() => {
    setOrders([...data]);
  }, [data]);
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-teachers",
    {}
  );
  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-teachers",
    {}
  );
