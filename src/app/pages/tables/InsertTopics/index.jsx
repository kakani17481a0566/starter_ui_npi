...
export default function InsertTopics() {
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage("column-visibility-insert-topics", {});
  const [columnPinning, setColumnPinning] = useLocalStorage("column-pinning-insert-topics", {});
    ...
    <>
      <div className="transition-content grid grid-cols-1 px-(--margin-x) py-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Topic Master List</h2>
          <Button
